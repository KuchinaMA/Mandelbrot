...
|---------------------|-----------|-----------|-----------|-----------------|
| -O0                 | 894.402   | 884.516   | 904.522   | 894  ± 10       |
| -O3                 | 420.541   | 425.601   | 430.086   | 425.4 ± 5       |

Таким образом, применение ключа оптимизации `-O3` ускоряет время работы программы в $\frac{894}{425.4} ≈ 2.10 ± 0.02$ раз.

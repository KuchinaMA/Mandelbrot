...
|---------------------|-----------|-----------|-----------|-----------------|
| -O0                 | 894.4     | 884.5     | 904.5     | 894.1  ± 10     |
| -O3                 | 420.5     | 425.6     | 430.1     | 425.4 ± 5       |

Таким образом, применение ключа оптимизации `-O3` ускоряет время работы программы в $\frac{894.1}{425.4} ≈ 2.10 ± 0.02$ раз.
